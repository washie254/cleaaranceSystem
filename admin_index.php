...
<body>
  ...
  <section class="section-testimonials section-t8 nav-arrow-a">
    ...
    <div class="container" style="padding: 6px 12px; border: 1px solid #ccc;">
      <h2>REGISTERED OFFICERS AND DEPARTMENTS</h2>
       QUICK LINKS: <a class="btn btn-success" href="#officers" role="button">Officers</a>
                    <a class="btn btn-success" href="#departments" role="button">Departments</a>
    </div> 
    <br>
    ...
    <div class="container" style="padding: 6px 12px; border: 1px solid #ccc;" id="departments">
      <h2>DEPARTMENTS</h2>
       the registered departments in the system
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            <th scope="col">Deoartment ID. </th>
            <th scope="col">Departmnent name</th>
          </tr>
        </thead>
        <tbody>
          <!-- [ LOOP THE REGISTERED OFFICERS ] -->
